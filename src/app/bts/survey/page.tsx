...
export default function BtsSurveyPage({ searchParams }: { searchParams: Promise<{ aid?: string }> }) {
  ...
  if (submitted) {
    return (
      <div className="motion-safe:bts-fade-in-up flex flex-col items-center justify-center py-12 px-6 text-center">
        ...
        <p className="mt-3 max-w-md text-sm text-brand-100/90 [text-shadow:0_2px_8px_rgba(0,0,0,0.55)]">
