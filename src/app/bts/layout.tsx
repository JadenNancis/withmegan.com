...
export const metadata: Metadata = {
  ...
  description:
    "A community book drive for families in Mt. St. George/Goodwood, Tobago. Register your dependents, upload book lists, and collect matched resources on event day.",
};
