...
export const metadata: Metadata = {
  ...
  description:
    "A community book drive for families in the Electoral District of Mt. St. George/Goodwood, Tobago. Register your dependents, upload book lists, and collect matched resources on event day.",
};
