...
export function InterestCard({
  ...
  return (
    <div className="mx-auto max-w-xl space-y-5 py-2 sm:py-6">
      <div className="rounded-2xl border border-brand-100 bg-white p-6 sm:p-10 text-center shadow-lg">
        <div className="motion-safe:bts-bounce-in mx-auto mb-6 flex h-20 w-20 sm:h-24 sm:w-24 items-center justify-center rounded-full bg-gradient-to-br from-brand-100 to-brand-50 shadow-inner">
        ...
        <p className="mx-auto mt-5 inline-flex items-center gap-2 rounded-full bg-brand-50 px-4 py-2 text-sm font-semibold text-brand-800 ring-1 ring-inset ring-brand-200">
        ...
        <p className="mx-auto mt-6 max-w-md text-sm text-gray-600 leading-relaxed">
          Back to School with Megan currently serves the Mt. St. George/Goodwood
