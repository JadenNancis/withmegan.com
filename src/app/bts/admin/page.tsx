    ...
    <div className="space-y-6">
      ...
      <form method="get" className="bts-fade-in-up bts-stagger-3 flex flex-col gap-2 sm:flex-row">
        <input
          ...
          className="flex-1 rounded-xl border border-gray-300 px-4 py-3 text-base shadow-sm focus:border-transparent focus:ring-2 focus:ring-cyan-500 focus:outline-none transition-shadow min-h-[48px]"
        />
        <button
          type="submit"
          className="rounded-xl bg-cyan-600 px-5 py-3 text-base font-bold text-white shadow-sm hover:bg-cyan-700 active:scale-95 transition-all min-h-[48px] sm:w-auto"
        >
          Search
        </button>
      </form>
