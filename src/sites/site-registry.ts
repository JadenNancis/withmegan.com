...
export const SITES: Record<SiteKey, SiteConfig> = {
  bts: {
    ...
    tagline: "Book Drive — The Electoral District of Mt. St. George/Goodwood, Tobago",
  ...
  md: {
    ...
    tagline: "Community Hamper Distribution — The Electoral District of Mt. St. George/Goodwood, Tobago",
