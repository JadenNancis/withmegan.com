...
export const BTS_SCHOOLS: readonly School[] = [
  ...
  { name: "Mt St George Methodist", category: "Primary / Middle" },
  ...
  { name: "St. Andrews Anglican", category: "Primary / Middle" },
  ...
  { name: "Goodwood Secondary", category: "Secondary / High" },
